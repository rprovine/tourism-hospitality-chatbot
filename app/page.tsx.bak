      ...
      <section id="demo" className="container mx-auto px-6 py-20">
        ...
        <div className="max-w-4xl mx-auto mb-8 p-4 bg-amber-50 border border-amber-200 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-amber-900 font-medium mb-1">Demo Mode - Simulated Responses</p>
              <p className="text-sm text-amber-800">
                These demos showcase the response style and capabilities of each tier using sample data. 
                In production, the AI will be trained on your actual business data, integrated with your booking systems, 
                and have access to real-time information specific to your property.
              </p>
            </div>
          </div>
        </div>
