 ...
 * Usage: npx ts-node scripts/remove-account.ts
 */
...
async function removeAccount(email: string) {
  ...
  try {
    ...
    // Since we're running this programmatically, we'll proceed
    // In a production script, you'd want to add a confirmation prompt
    
    console.log('\n🔄 Starting deletion...')

    // Delete in order of dependencies
    // Most of these will cascade delete due to onDelete: Cascade in schema
